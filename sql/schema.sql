...
CREATE TABLE users (
    ...
    phone VARCHAR(20), -- New: optional phone number
    profile_picture VARCHAR(255), -- New: path or URL to profile picture
...
CREATE TABLE stock_logs (
    id INT AUTO_INCREMENT PRIMARY KEY,
    product_id INT           NOT NULL,
    changes VARCHAR(50)      NOT NULL,  -- Changed from INT to VARCHAR to store "Added 5 Stock" or "Reduced 5 Stock"
